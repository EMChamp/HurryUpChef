...
class Playfield(object):
    def __init__(self, level): # initialize cursor and ingredients on playfield
        # initial state
        ...
        self.init_playfield()
        self.enableLevelTwo = False
        self.enableLevelThree = False
    ...
    def clear_matches(self): # clear matches of 3 or more ingredients
        ...
        if clear_set:
            if len(clear_set) == 3:
                self.screen_stats.scoreCount += MATCHTHREE
            elif len(clear_set) == 4:
                self.screen_stats.scoreCount += MATCHFOUR
            elif len(clear_set) == 5:
                self.screen_stats.scoreCount += MATCHFIVE
            elif len(clear_set) > 5:
                self.screen_stats.scoreCount += MATCHMORE
